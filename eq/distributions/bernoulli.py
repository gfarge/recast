# From https://github.com/pytorch/pytorch/blob/main/torch/distributions/bernoulli.py
...
class Bernoulli(ExponentialFamily):
    ...
    Args:
        probs (Number, Tensor): the probability of sampling `1`, p
        logits (Number, Tensor): the log-odds of sampling `1`, log(p/(1-p))
    """
    ...
    def log_prob(self, value):
        ...
        return (value == 0)*(1 - self.probs) + (value == 1)*(self.probs)
