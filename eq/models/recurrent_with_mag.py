...
class RecurrentMTPP(TPPModel):
    ...
    def __init__(
        ...
        self.logged_valid_time_loss = []
        self.logged_valid_mag_loss = []

        loss_weights = []
        # Decoder for the time distribution
        if predict_time is True:
        ...
        # time and magnitude
        self.num_rnn_inputs = int(input_time) + int(input_magnitude)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = ((nll_dict['nll_time'] + nll_dict['nll_mag'])/2).mean()
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.logged_valid_time_loss.append(nll_dict['nll_time'].item())
        self.logged_valid_mag_loss.append(nll_dict['nll_mag'].item())
